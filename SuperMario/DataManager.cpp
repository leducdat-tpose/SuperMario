...
void CDataManager::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
...
void CDataManager::Render()
{
	RECT rect;
	SetRect(&rect, 74, 212, 226, 240);

	if (game->GetFont() != NULL)
		game->GetFont()->DrawTextA(NULL, information.c_str(), -1, &rect, DT_LEFT, D3DXCOLOR(117 / 255, 255 / 255, 255 / 255, 0.0f));
}